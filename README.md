...
Repositorio de Benicio Sánchez Mandato. Con las actividades hechas durante el año en Instalación y Reemplazo de Componentes Internos


## Contenidos

- **[Assembler/](./Assembler)**: En esta carpeta se encuentra el archivo con las Pruebas de las instrucciones en el procesador y se encuentra otra carpeta que contiene el snake. Además se encuentra un archivo con un filesystem en assembly
